...
class CoreInterface :
    ...
    def search_square_error(self, sqr_id:int) -> ... :
        """Vérifie
        """
    ...
    def compute_choices(self) :
        win_state, choices = self.core.choices()
...
class GameViewer(tk.Tk) :
    ...
    def __init__(self, core:chess.Chessgame, fenstr:str=None) :
        ...
        self.core_state = TextBox(right_frame, 'core state', height=28, width=38)
        self.possibilities = TextBox(right_frame, 'possibilities', height=23, width=38)
...
def start_debug_ui(fenstr:str=None) :
    """Lance l'interface de debugage dans un autre thread. Le noyau CORE peut
    donc être manipulé en temps réel lors de l'execution dans une console
    IPython
    """
...
if __name__ == '__main__' :
    ...
    #index_error_fenstfing = "8/2p5/3p4/1P5r/KR3p1k/8/4P1P1/8 b Qq - 0 1"
